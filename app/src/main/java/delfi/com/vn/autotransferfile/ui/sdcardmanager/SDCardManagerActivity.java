package delfi.com.vn.autotransferfile.ui.sdcardmanager;
...
import delfi.com.vn.autotransferfile.common.dialog.AddItemsDialog;
import delfi.com.vn.autotransferfile.common.dialog.ConfirmDeleteDialog;
import delfi.com.vn.autotransferfile.common.dialog.NewFolderDialog;
import delfi.com.vn.autotransferfile.common.dialog.NewTextFileDialog;
import delfi.com.vn.autotransferfile.common.dialog.RenameDialog;
import delfi.com.vn.autotransferfile.common.dialog.UpdateItemDialog;
import dk.delfi.core.common.activity.BaseActivity;


public class SDCardManagerActivity extends BaseActivity implements
    ...
    public static final String TAG = SDCardManagerActivity.class.getSimpleName();
    ...
    public void onClick(File file) {
        if (file.isDirectory()) {
            ...
            try {
                ...
                String mimeType =  MimeTypeMap.getSingleton().getMimeTypeFromExtension(Helper.fileExt(file.getAbsolutePath()));
    ...
    public void onNewFolder(String name) {
        ...
        Log.d(TAG,"show path : "+folderPath + " : "+name);
